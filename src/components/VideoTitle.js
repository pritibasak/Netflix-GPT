...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[20%] px-24 absolute bg-gradient-to-r from-black">
      ...
      <p className="py-6 font-semibold text-md w-1/4 text-white">{overview}</p>
      <div>
        <button className="bg-white text-black rounded-lg px-12 py-4 text-2xl font-semibold hover:bg-opacity-80">
          ▶Play
        </button>
        <button className="bg-gray-400 text-white font-semibold rounded-lg px-12 py-4 mx-3 text-2xl bg-opacity-50">
          <img
